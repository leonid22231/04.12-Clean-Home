...
class OrdersCleaner extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _OrderCleaner();
  }
}

class _OrderCleaner extends State<OrdersCleaner> {
  ...
  Future<List<OrderModel>> getOrders() async {
    ...
    RestClient restClient = RestClient(dio);
    String? token = await GlobalWidgets.getToken();
    return restClient.findOrdersCleaner("Bearer $token");
  }
}
